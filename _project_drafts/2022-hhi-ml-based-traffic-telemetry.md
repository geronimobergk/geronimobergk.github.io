...
2. **Forecast target** – predicting *traffic maxima* rather than means
...
* Developed an **LSTM-based forecasting model** trained on historical *hourly maximum traffic values* to predict future maxima one hour ahead.
